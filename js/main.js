...
const translations = {
  es: {
    ...
    'project2-note1': '<i class="fa-solid fa-info-circle"></i> <strong>Nota del Dataset:</strong> Los datasets proporcionados tienen las columnas de clasificación/objetivo eliminadas para permitir análisis de clustering no supervisado real.',
    'project2-note2': '<i class="fa-solid fa-download"></i> <strong>Prueba la Carga de Archivos:</strong> <a href="assets/data/cars.csv" download class="inline-link">Descarga el dataset Cars</a> para probar la funcionalidad de carga de archivos personalizados.',
    'project2-note3': '<i class="fa-solid fa-lightbulb"></i> <strong>Recomendado para Principiantes:</strong> Comienza con el dataset Iris, tiene clusters naturales bien definidos y es el más fácil de interpretar.',
    ...
    'project3-note1': '<i class="fa-solid fa-info-circle"></i> <strong>Nota del Dataset:</strong> El dataset Cars incluido clasifica vehículos en categorías de aceptabilidad basándose en características como precio, mantenimiento, puertas, capacidad de pasajeros, maletero y seguridad.',
    'project3-note2': '<i class="fa-solid fa-sliders"></i> <strong>Configuración Flexible:</strong> Ajusta hiperparámetros en tiempo real para observar cómo afectan la estructura del árbol, las reglas extraídas y las métricas de rendimiento.',
    'project3-note3': '<i class="fa-solid fa-lightbulb"></i> <strong>Recomendado para Principiantes:</strong> El dataset Cars incluido tiene reglas de decisión claras y es ideal para entender cómo funcionan los árboles de decisión.',
  ...
  en: {
    ...
    'project2-note1': '<i class="fa-solid fa-info-circle"></i> <strong>Dataset Note:</strong> Provided datasets have classification/target columns removed to enable true unsupervised clustering analysis.',
    'project2-note2': '<i class="fa-solid fa-download"></i> <strong>Test Upload Feature:</strong> <a href="assets/data/cars.csv" download class="inline-link">Download Cars dataset</a> to test the custom file upload functionality.',
    'project2-note3': '<i class="fa-solid fa-lightbulb"></i> <strong>Recommended for Beginners:</strong> Start with the Iris dataset, it has well-defined natural clusters and is easiest to interpret.',
    ...
    'project3-note1': '<i class="fa-solid fa-info-circle"></i> <strong>Dataset Note:</strong> The included Cars dataset classifies vehicles into acceptability categories based on features like price, maintenance, doors, passenger capacity, trunk size, and safety.',
    'project3-note2': '<i class="fa-solid fa-sliders"></i> <strong>Flexible Configuration:</strong> Adjust hyperparameters in real time to observe how they affect tree structure, extracted rules and performance metrics.',
    'project3-note3': '<i class="fa-solid fa-lightbulb"></i> <strong>Recommended for Beginners:</strong> The included Cars dataset has clear decision rules and is ideal for understanding how decision trees work.',
