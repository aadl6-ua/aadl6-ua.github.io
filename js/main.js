...
const translations = {
  es: {
    ...
    'project3-note2': '<i class="fa-solid fa-download"></i> <strong>Prueba la Carga de Archivos:</strong> <a href="assets/data/iris.csv" download class="inline-link">Descarga el dataset Iris</a> para probar la funcionalidad de carga de archivos personalizados.',
    'project3-note3': '<i class="fa-solid fa-lightbulb"></i> <strong>Recomendado para Principiantes:</strong> Usa el dataset Cars con estos parámetros: Gini, Test Size 0.25, Max Depth 5, Min Split 10, Min Leaf 5.',
  ...
  en: {
    ...
    'project3-note2': '<i class="fa-solid fa-download"></i> <strong>Test Upload Feature:</strong> <a href="assets/data/iris.csv" download class="inline-link">Download Iris dataset</a> to test the custom file upload functionality.',
    'project3-note3': '<i class="fa-solid fa-lightbulb"></i> <strong>Recommended for Beginners:</strong> Use the Cars dataset with these parameters: Gini, Test Size 0.25, Max Depth 5, Min Split 10, Min Leaf 5.',
